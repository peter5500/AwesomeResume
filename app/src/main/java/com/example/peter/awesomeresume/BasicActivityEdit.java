...
import com.example.peter.awesomeresume.util.PermissionUtils;

public class BasicActivityEdit extends EditBaseActivity<BasicInfo> {
    ...
    protected void setupUIForEdit(@NonNull BasicInfo data) {
        ((EditText) findViewById(R.id.basic_edit_name))
                .setText(data.name);
        ((EditText) findViewById(R.id.basic_edit_email))
                .setText(data.email);
        ...
        findViewById(R.id.basic_edit_image_layout).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!PermissionUtils.checkPermission(BasicActivityEdit.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE)) {
                    PermissionUtils.requestReadExternalStoragePermission(BasicActivityEdit.this);
                } else {
                    pickImage();
                }
            }
    ...
    protected void saveAndExit(@Nullable BasicInfo data) {
        ...
        data.name = ((EditText) findViewById(R.id.basic_edit_name)).getText().toString();
        data.email = ((EditText) findViewById(R.id.basic_edit_email)).getText().toString();
        data.imageUri = (Uri) findViewById(R.id.basic_edit_image).getTag();
    ...
    private void showImage(@NonNull Uri imageUri) {
        ImageView imageView = (ImageView) findViewById(R.id.basic_edit_image);
